% rasti_guide.tex
%
% RASTI LaTeX user guide
%
% v1.4 released 23 April 2023
%
% Copyright (C) Royal Astronomical Society 2024
% Authors:
% Peter Jones (Oxford University Press), adapted from MNRAS_guide Keith T. Smith (Royal Astronomical Society)
...
% v1.3   July 2023
%    Updated guidance on use of amssyb package 
% v1.2   April 2022
%    User guide adapted from MNRAS guide to match RASTI requirements
%    Basic structure taken from rasti_template.tex by the same author

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Basic setup. Most papers should leave these options alone.
\documentclass[fleqn,usenatbib,useAMS]{rasti}
...
% The RASTI class isn't designed to include a table of contents, but for this document one is useful.
